...
namespace ScreenSaver
{
	public partial class Form1 : Form
	{
		...
		private readonly Star[] _stars = new Star[8000];
		...
		private void DrawStar(Star star)
		{
			...
			float x = Map(star.X / star.Z, 0, 1, 0, pictureBox1.Width) + (float)pictureBox1.Width / 2;

			float y = Map(star.Y / star.Z, 0, 1, 0, pictureBox1.Height) + (float)pictureBox1.Height / 2;
